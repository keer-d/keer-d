...
(function () {
  ...
  var STEPS = [
    ...
    { id: 'map-split',ch: 'Origin', cam: 'wideFront', scene: 'map', beat: 4, dim: 2 },
    { id: 'map-flow', ch: 'Origin', cam: 'wideFront', scene: 'map', beat: 5, dim: 2 },
    { id: 'map-haut', ch: 'Origin', cam: 'wideFront', scene: 'map', beat: 6, dim: 2 },
    { id: 'map-hm',   ch: 'Origin', cam: 'wideFront', scene: 'map', beat: 7, dim: 2 },
    ...
    { id: 'ap-holds', ch: 'Appellation', cam: 'wideFront', scene: 'appellation', beat: 4, dim: 2 },
    { id: 'ap-here',  ch: 'Appellation', cam: 'wideFront', scene: 'appellation', beat: 5, dim: 2 },
